...
namespace iface {
  ...
  class SingleComment extends \DrSlump\Protobuf\Message {
    ...
    public static function descriptor()
    {
      ...
      // REPEATED MESSAGE RefComments = 12
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 12;
      $f->name      = "RefComments";
      $f->type      = \DrSlump\Protobuf::TYPE_MESSAGE;
    ...
    /**
     * Check if <MarkRead> has a value
     *
     * @return boolean
     */
    public function hasMarkRead(){
      return $this->_has(9);
    }
    
    /**
     * Clear <MarkRead> value
     *
     * @return \iface\SingleComment
     */
    public function clearMarkRead(){
     ...
     * @return \iface\SingleComment
     */
    public function setMarkRead( $value){
    ...
    /**
     * Check if <RefComments> has a value
     *
     * @return boolean
     */
    public function hasRefComments(){
      return $this->_has(12);
    }
    
    /**
     * Clear <RefComments> value
     *
     * @return \iface\SingleComment
     */
    public function clearRefComments(){
      return $this->_clear(12);
    }
    
    /**
     * Get <RefComments> value
     *
     * @param int $idx
     * @return \iface\SingleComment
     */
    public function getRefComments($idx = NULL){
      return $this->_get(12, $idx);
    }
    
    /**
     * Set <RefComments> value
     *
     * @param \iface\SingleComment $value
     * @return \iface\SingleComment
     */
    public function setRefComments(\iface\SingleComment $value, $idx = NULL){
      return $this->_set(12, $value, $idx);
    }
    
    /**
     * Get all elements of <RefComments>
     *
     * @return \iface\SingleComment[]
     */
    public function getRefCommentsList(){
     return $this->_get(12);
    }
    
    /**
     * Add a new element to <RefComments>
     *
     * @param \iface\SingleComment $value
     * @return \iface\SingleComment
     */
    public function addRefComments(\iface\SingleComment $value){
...
namespace iface {
  ...
  class GetCommentsOfDocRequest extends \DrSlump\Protobuf\Message {
    ...
    public static function descriptor()
    {
      ...
      // REPEATED STRING UserIdFilter = 9
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 9;
      $f->name      = "UserIdFilter";
      $f->type      = \DrSlump\Protobuf::TYPE_STRING;
    ...
    /**
     * Check if <UserIdFilter> has a value
     *
     * @return boolean
     */
    ...
    /**
     * Clear <UserIdFilter> value
     *
     * @return \iface\GetCommentsOfDocRequest
     */
    public function clearUserIdFilter(){
      return $this->_clear(9);
    }
     ...
     * @return string
     */
    public function getUserIdFilter($idx = NULL){
     ...
     * @return \iface\GetCommentsOfDocRequest
     */
    public function setUserIdFilter( $value, $idx = NULL){
      return $this->_set(9, $value, $idx);
    }
    
    /**
     * Get all elements of <UserIdFilter>
     *
     * @return string[]
     */
    public function getUserIdFilterList(){
     return $this->_get(9);
    }
    
    /**
     * Add a new element to <UserIdFilter>
     *
     * @param string $value
     * @return \iface\GetCommentsOfDocRequest
     */
    public function addUserIdFilter( $value){
...
namespace iface {
  ...
  class MarkNotificationReadRequest extends \DrSlump\Protobuf\Message {

    /**  @var int[]  */
    public $NotificationId = array();
    ...
    public static function descriptor()
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'iface.MarkNotificationReadRequest');
     ...
     * Clear <NotificationId> value
     *
     * @return \iface\MarkNotificationReadRequest
     */
    public function clearNotificationId(){
      return $this->_clear(1);
    }
     ...
     * @return int
     */
    public function getNotificationId($idx = NULL){
     ...
     * @return \iface\MarkNotificationReadRequest
     */
    public function setNotificationId( $value, $idx = NULL){
      return $this->_set(1, $value, $idx);
    }
    
    /**
     * Get all elements of <NotificationId>
     *
     * @return int[]
     */
    public function getNotificationIdList(){
     return $this->_get(1);
    }
    
    /**
     * Add a new element to <NotificationId>
     *
     * @param int $value
     * @return \iface\MarkNotificationReadRequest
     */
    public function addNotificationId( $value){
...
namespace iface {
  ...
  class MarkNotificationReadResponse extends \DrSlump\Protobuf\Message {
    ...
    public static function descriptor()
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'iface.MarkNotificationReadResponse');
     ...
     * Clear <Response> value
     *
     * @return \iface\MarkNotificationReadResponse
     */
    public function clearResponse(){
      return $this->_clear(1);
    }
...
namespace iface {
  ...
  class CommentServiceClient extends \Grpc\BaseStub {
    ...
    /**
     * @param iface\MarkNotificationReadRequest $input
     */
    public function MarkNotificationRead(\iface\MarkNotificationReadRequest $argument, $metadata = array(), $options = array()) {
      return $this->_simpleRequest('/iface.CommentService/MarkNotificationRead', $argument, '\iface\MarkNotificationReadResponse::deserialize', $metadata, $options);
    }
  }
}
namespace iface {
  ...
  class CallbackServiceClient extends \Grpc\BaseStub {
    ...
    /**
     * @param iface\SingleComment $input
     */
    public function OnReply(\iface\SingleComment $argument, $metadata = array(), $options = array()) {
