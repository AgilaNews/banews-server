...
namespace iface {
  ...
  class CheckNotificationRequest extends \DrSlump\Protobuf\Message {
    ...
    /**
     * Check if <NewestId> has a value
     *
     * @return boolean
     */
    public function hasNewestId(){
      return $this->_has(4);
    }
    
    /**
     * Clear <NewestId> value
     *
     * @return \iface\CheckNotificationRequest
     */
    public function clearNewestId(){
      return $this->_clear(4);
    }
     ...
     * @return \iface\CheckNotificationRequest
     */
    public function setNewestId( $value){
      return $this->_set(4, $value);
    }
  }
}
...
namespace iface {
  ...
  class Empty extends \DrSlump\Protobuf\Message {
    ...
    public static function descriptor()
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'iface.Empty');
...
namespace iface {
  ...
  class CommentServiceClient extends \Grpc\BaseStub {
    ...
    public function DelComment(\iface\DelCommentRequest $argument, $metadata = array(), $options = array()) {
      return $this->_simpleRequest('/iface.CommentService/DelComment', $argument, '\iface\Empty::deserialize', $metadata, $options);
    }
    /**
...
namespace iface {
  ...
  class CallbackServiceClient extends \Grpc\BaseStub {
    ...
    public function OnReply(\iface\OnReplyCallbackRequest $argument, $metadata = array(), $options = array()) {
      return $this->_simpleRequest('/iface.CallbackService/OnReply', $argument, '\iface\Empty::deserialize', $metadata, $options);
    }
    /**
    ...
    public function OnLiked(\iface\OnLikedCallbackRequest $argument, $metadata = array(), $options = array()) {
      return $this->_simpleRequest('/iface.CallbackService/OnLiked', $argument, '\iface\Empty::deserialize', $metadata, $options);
    }
  }
}
