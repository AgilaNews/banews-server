...
define('CACHE_SNS_WIDGET_PREFIX', "BS_SNS_WIDGET_");
define('CACHE_SNS_WIDGET_TTL', 14400);
...
define('CACHE_NEWS_RECOMMEND_PREFIX', "BS_NEWS_RECOMMEND_V4_");
define('CACHE_NEWS_RECOMMEND_TTL', 3600);
define("CACHE_CHANNELS_V2_KEY", "BS_CHANNELS_V2_%s");
define("CACHE_CHANNELS_V2_TTL", 3600);
...
define("DETAIL_IMAGE_PATTERN", IMAGE_PREFIX . "/%s.jpg?p=s=%sX%s_w|q=%d");
